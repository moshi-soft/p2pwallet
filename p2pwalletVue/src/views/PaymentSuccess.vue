<template>
  ...
  <div class="flex items-center">
    ...
    <h3 class="text-lg font-medium text-green-700 dark:text-green-800">Payment has been successfully completed</h3>
  </div>
  <div class="mt-2 mb-4 text-sm text-green-700 dark:text-green-800">
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Rerum, provident dignissimos! Doloribus voluptas perspiciatis beatae vitae minus corporis maiores voluptates nihil, accusantium voluptate numquam exercitationem recusandae quae quis obcaecati voluptatum.
  </div>
  <div class="flex">
    <router-link to="payment" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-xs px-3 py-1.5 mr-2 text-center inline-flex items-center dark:bg-green-800 dark:hover:bg-green-900">
